...
<h4 id="room-title">Cake</h4>

<div id="cake-content" class="miestnosti-big-box">
    <div class="miestnosti-box">
        ...
        <div class="miestnosti rectangle-room-img">
            <img src="/public/images/miestnosti/kitchen1.jpg" alt="">
        </div>
    </div>

    <div class="miestnosti-box">
        <div class="miestnosti rectangle-room-img">
            <img src="/public/images/miestnosti/kitchen2.jpg" alt="">
        </div>
